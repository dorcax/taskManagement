...
return ()=>{
  ...
  return (
    <div className='border border-solid rounded-lg h-screen bg-[#212121] border-stone-600  px-10 lg:w-[85%] sm:w-full fixed overflow-y-auto '>
   ...
   <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-6 py-2 sm:gap-10">
       ...
       <div className='flex justify-between mx-3 py-4 items-center'>
        ...
        <button className='border border-solid px-6 py-2 rounded-full text-xl bg-red-800 text-white capitalize'>{er.status}</button></div>
